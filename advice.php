    ...
    <div class="textblock" id="textblock1">
        <div class="content_second">
          <div class="content_dir1">
            ...
            <ul>
                <li class="boxlist">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </li>
                <li class="boxlist">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</li>
